...
- Before making non-trivial changes, read and follow `RULES.md`. For any Habitica API work, read `HABITICA_API.md` before editing code. For UI/UX work, read `docs/UX_UI_MANIFEST.md` before editing UI code, styles, or user-facing copy. Keep `TECHNICAL.md` updated when foundational technical decisions change, and keep `FEATURES.md` updated when features are added, changed, deprecated, or removed.
