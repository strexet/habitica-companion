...
> **Historical only:** Do not execute this plan task-by-task. The checklist below records the original MVP implementation path and may refer to files that now exist or behavior that has since changed.
